...
public class RunebaseTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public RunebaseTestNetParams() {
        super();
        interval = INTERVAL;
        ...
        genesisBlock.setTime(1529488943L);
        genesisBlock.setNonce(13021);
        id = ID_RUNEBASE_TESTNET;
        subsidyDecreaseBlockCount = 525960000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("00001c1c4c03ce2958600754ab7b20b5d0aef52c9472a7942a49175c0aa6268b"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("00001c1c4c03ce2958600754ab7b20b5d0aef52c9472a7942a49175c0aa6268b"));
    ...
    private static RunebaseTestNetParams instance;
    public static synchronized RunebaseTestNetParams get() {
        if (instance == null) {
            instance = new RunebaseTestNetParams();
        }
        return instance;
    }
