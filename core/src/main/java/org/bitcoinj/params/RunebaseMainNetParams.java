...
public class RunebaseMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public RunebaseMainNetParams() {
        super();
        interval = INTERVAL;
        ...
        genesisBlock.setTime(1530246365L);
        genesisBlock.setNonce(192857);
        id = ID_RUNEBASE_MAINNET;
        subsidyDecreaseBlockCount = 525960000;
        spendableCoinbaseDepth = 100; //?
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("0000c5edbe6f9c21b0c77e568b8339dc5e8ffdf78fe14fd3b1a2ea51c7f710fd"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("0000c5edbe6f9c21b0c77e568b8339dc5e8ffdf78fe14fd3b1a2ea51c7f710fd"));
        checkpoints.put(2000, Sha256Hash.wrap("000078083638b47e82675d657be9a31f7d36119186fb14bfee72fe3e6d78d488"));
        checkpoints.put(2583, Sha256Hash.wrap("371e278ce135b6a63a0b10ba73c0a54b4745e5b95118362a75d77313095f1ce6"));
        checkpoints.put(21000, Sha256Hash.wrap("ea8336433fbd537144c2f7a7079829d624c3515f91220de186c02ff9dddd2366"));
    ...
    private static RunebaseMainNetParams instance;
    public static synchronized RunebaseMainNetParams get() {
        if (instance == null) {
            instance = new RunebaseMainNetParams();
        }
        return instance;
    }
